...
type ProductServiceClient interface {
	// A function which take a product with Id
	GetProduct(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductResponse, error)
	SearchProducts(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchListResponse, error)
}
...
func (c *productServiceClient) SearchProducts(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*SearchListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	SearchProducts(context.Context, *SearchRequest) (*SearchListResponse, error)
...
func (UnimplementedProductServiceServer) SearchProducts(context.Context, *SearchRequest) (*SearchListResponse, error) {
